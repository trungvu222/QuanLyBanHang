...
namespace QuanLyBanHang
{
    public partial class frmHoaDonBan : Form
    {
        ...
        {
            string sql;
            sql =   "SELECT B.MaHang, B.TenHang, A.SoLuong, B.GiaBan, A.GiamGia, A.ThanhTien " +
                    "FROM tblChiTietHDBan AS A INNER JOIN tblHang AS B ON A.MaHang = B.MaHang " +
                    "WHERE  A.MaHang = B.MaHang AND A.MaHDBan = '"+ txtMaHDBan.Text +"'";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO tblHDBan(MaHDBan,NgayBan,MaKhach,MaNhanVien,TongTien) VALUES (N'" + txtMaHDBan.Text.Trim() + "','" +
                        dtpNgayBan.Value + "',N'" + cboMaKhach.SelectedValue + "',N'" +
                        cboMaNhanVien.SelectedValue + "'," + txtTongTien.Text + ")";
            ...
            sql = "INSERT INTO tblChiTietHDBan(MaHang,MaHDBan,SoLuong,DonGia,GiamGia,ThanhTien)" +
                "VALUES('" + cboMaHang.SelectedValue + "','"+ txtMaHDBan.Text.Trim() +"' ," + txtSoLuong.Text + "," + txtDonGiaBan.Text + "," + txtGiamGia.Text + "," + txtThanhTien.Text + ")";
            Functions.RunSQL(sql);
            LoadDataGridView();
        ...
        private void cboMaHang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            str = "SELECT GiaBan FROM tblHang WHERE MaHang ='" + cboMaHang.SelectedValue + "'";
        ...
        private void cboMaKhach_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            str = "Select TenKhach from tblKhachHang where MaKhach = '" + cboMaKhach.SelectedValue + "'";
            txtTenKhach.Text = Functions.GetFieldValues(str);
            str = "Select DiaChi from tblKhachHang where MaKhach = '" + cboMaKhach.SelectedValue + "'";
            txtDiaChi.Text = Functions.GetFieldValues(str);
            str = "Select DienThoai from tblKhachHang where MaKhach= '" + cboMaKhach.SelectedValue + "'";
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A3:B3"].Value = "Điện thoại: (05)28592362";
            ...
            sql = "SELECT a.MaHDBan, a.NgayBan, a.TongTien, b.TenKhach, b.DiaChi, b.DienThoai, c.TenNhanVien FROM tblHDBan AS a, tblKhachHang AS b, tblNhanVien AS c WHERE a.MaHDBan = N'" + txtMaHDBan.Text + "' AND a.MaKhach = b.MaKhach AND a.MaNhanVien = c.MaNhanVien";
        ...
        private void dtpNgayBan_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        }

        private void cboMaNhanVien_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        }

        private void cboMaKhach_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        }
        ...
        private void cboMaHDBan_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        }
